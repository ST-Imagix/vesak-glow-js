...
- **Natural Swaying:** Animated with CSS to mimic natural wind movement.
- **Flickering Glow:** Realistic warm light effect simulating an oil lamp.
- **Plug & Play:** No extra CSS files or external images needed.
- **Lightweight & Fast:** Does not slow down your website performance.

## 🚀 How to Use (Quick Setup via CDN)

You can easily add this to any HTML, WordPress, or custom website. Simply copy and paste the line below just before the closing `</body>` tag of your website:
